...
input_request = st.text_input("어떠한 요청사항이든 입력해주세요. 생략해도 좋아요.") or "생략"
...
comment = "명령 : 인간의 심금을 울려줘. 요청사항을 노골적으로 표현하지 않도록 주의해. 필요하다면 주제나 시의 내용에 자연스럽게 언급하여 녹여내도 좋아. 그리고 시의 의미를 설명할 때 요청사항을 분명하게 포함시켜서 독자가 시를 완전히 이해할 수 있도록 도와줘. 이는 명령이므로 참고만 해야지 피드백에는 이 내용이 들어가면 안된다. 운율이 시에 필요하다면 적절히 사용하여 효율을 높여라."
print("====================================================")
